...
person_shopping_join = shop_trips %>% left_join(person, by = c("person_id" = "person_id") )
shop_trips_gender<-create_table_one_var('gender', person_shopping_join, 'trip') 
...
person_days_2<-merge(person_days, person, by.x='personid', by.y='person_id')
